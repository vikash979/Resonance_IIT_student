...
from .models import Classs,Batches,Target,StudentClassPath,SessionHasProgram,Programhasclasses,Programs,PhaseHasSession,FacultyHasBatch,Sessions,Programclasshassubjects
    ...
    def create(self, request): 
        ...
        if request.data.get('action') =='add': 
            ...
            if len(data_error)==0:   
                ...
                class_obj = Classs.objects.get_or_create(name=request.data['name'],display_name=request.data['display_name'],
            ...
            if request.data.get('id')!= None:
                ...
                for key,value in conditionn.items(): 
                    ...
                    if key=='id':
                        ...
                        class_obj = Classs.objects.filter(Q(name__contains=value) | Q(display_name__contains=value))
            ...
            class_ob = Classs.objects.filter(name=request.data['name'],display_name=request.data['display_name'], order=request.data['order'],description=request.data['description']).count()
            if class_ob == 0:
...
class ProgramsViewset(viewsets.ModelViewSet):
    ...
    def pagination_data(self,program_numpage,users,page):
    ...
    def create(self, request, *args, **kwargs): 
        ...
        if request.data.get('action') =='add':
            ...
            program_obj = Programs.objects.get_or_create(name=request.data['name'],
            ...
            if request.data.get('id')!= None:
                ...
                for key,value in conditionn.items(): 
                    if key=='id':
                        if isinstance(value, int):
                            value = [value,]
                        program_obj = Programs.objects.filter(id__in=value) 
                    else:
                    
                    
                        program_obj = Programs.objects.filter(Q(name__contains=value) | Q(display_name__contains=value))
                        if request.data.get('page')==None:
                            page =1
                        else:
                            page = int(request.data.get('page'))
                        ...
                        #pagination_obj = self.pagination_data(program_numpage,users,page)

                        #pagination_data(program_numpage,users,page)
                ...
                if program_numpages > 0:
                    ...
                    if program_next != True:
                        ...
                        program_record = {"program_numpage":program_numpages,"program_next":program_next,"program_previous":program_previous,"program_user_changes":program_user_changes,"program_previous_page":program_previous_page,"program_index":program_index,"program_end":program_end,"current_page":current_page,"program_next_page_number":program_next_page_number}
    ...
    def update(self, request, *args, **kwargs):
        ...
        try:
            if len(data_error) == 0: 
                program_obj = Programs.objects.filter(id=request.data['id']).update(name=program['name'],display_name=program['display_name'],description=program['description'],type=program['type'],target=Target.objects.get(id=request.data['target']))
...
class SessionsViewset(viewsets.ModelViewSet):
    ...
    def create(self,request):
        ...
        #created_by = request.data['created_by']
            ...
            obj = Sessions.objects.latest('id')
            SessionHasProgram.objects.create(session=obj,program=Programs.objects.get(id=request.data['program']))
...
#####################################SessionHasProgramViewset############
class SessionHasProgramViewset(viewsets.ModelViewSet):
    queryset = SessionHasProgram.objects.all()
    serializer_class = serializers.SessionHasProgramSerializer
    ...
    def create(self,request):
        ...
        if request.data.get('action') =='view':  
            if request.data.get('id')!= None:
                ...
                session_program = SessionHasProgram.objects.filter(id=request.data.get('id')) 
            elif request.data.get('identr')  !=None:
                    
                    session_program = SessionHasProgram.objects.all()
                    serializer_obj = serializers.SessionHasProgramSerializer(session_program,many=True)

            elif request.data.get('conditions')  !=None:
                condition = request.data.get('conditions') 
                conditionn = json.loads(condition) 
                for key,value in conditionn.items(): 
                    session_program = SessionHasProgram.objects.filter(id=value)                    
            else:
                session_program = SessionHasProgram.objects.all()
                #-----------------------------------------------------
                if request.data.get('page')==None:
                ...
                paginator = Paginator(session_program,2)
                try:
            ...
            if request.data.get('id')!= None:
                ...
                serializer_obj = serializers.SessionHasProgramSerializer(users,many=True)
    ...
    def create(self,request):
        ...
        if request.data.get('action') =='add':
            ...
            #has_subjects['created_by'] = User.objects.get(id=request.data['created_by'])
                ...
                end_date=request.data['end_date'],program_session=SessionHasProgram.objects.get(id=request.data['session']))
...
class TargetProgramViewset(viewsets.ModelViewSet):   
    queryset = Target.objects.all()
    serializer_class = serializers.TargetsSerializer
    ...
    def create(self, request): 
        ...
        if request.data.get('action') =='view':
            if request.data.get('id')!= None:
                class_obj = Target.objects.filter(id=request.data.get('id')) 
            elif request.data.get('conditions')  !=None:
                condition = request.data.get('conditions') 
                conditionn = json.loads(condition) 
                for key,value in conditionn.items(): 
                    ...
                    if key=='id':
                        ...
                        class_obj = Target.objects.filter(Q(name__contains=value))
                        if request.data.get('page')==None:
                            page =1
                        else:
                            page = int(request.data.get('page'))
            ...
            if request.data.get('id')!= None:
                ...
                serializer_obj = serializers.TargetsSerializer(class_obj,many=True) 
                data= {"data":serializer_obj.data,"status": True,"errors":data_error} 
                ...
                serializer_obj = serializers.TargetsSerializer(users,many=True)
                data= {"data":serializer_obj.data,"status": True,"errors":data_error,"paginations":pagination_obj}
