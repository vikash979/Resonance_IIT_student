...
var max_page = 0;
    ...
    $(window).on('load',function(){
        ...
        $('#employements_page').addClass("active");
                ...
                success: function(response){
                    if (response.status != false) {
                        for(var i=0;i<response.data.length;i++){
                            $('.listingtable').append(`<tr><td class='division-title'>${response.data[i].et_name}</td><td class='division-actions'><a href="javascript:void(0);" class='edit-link' onclick="editEt(${response.data[i].id})"><i class="fa fa-pencil"></i></a><a href="javascript:void(0);" onclick="removeEt(${response.data[i].id})"><i class="fa fa-trash"></i></a></td></tr>`);
                            department_count+=1;
                        }
                        $('#et_count').html(department_count);
        ...
        $.ajax({
            ...
            success: function(response){
                if (response.status != false) {
                    ...
                    $('#edit_value').val(response.data.et_name);
    ...
    jQuery(document).ready(function(){
       ...
       $('#namedd').selectpicker(); 
        ...
        $('#add-employementType').on('submit',function(e){
            e.preventDefault();
